    ...
    <div className="min-h-screen bg-gray-950 text-white p-6">
      ...
      <div className="mb-6 p-4 bg-gray-900 border border-gray-700 rounded">
        ...
        <div className="mb-4">
          ...
          <div className="flex bg-gray-800 rounded p-2 overflow-x-auto">
            {Array.from({ length: 16 }, (_, i) => (
              <div
                key={i}
                className="border-r border-gray-600 flex flex-col items-center justify-center text-xs bg-gray-700 mr-1"
                style={{
                  width: `${zoom}px`,
                  height: "40px",
                  minWidth: `${zoom}px`,
        ...
        <div className="mb-4">
          ...
          <div
            className="relative bg-gray-800 rounded p-2 overflow-x-auto"
            style={{ height: "50px" }}
          >
            {/* Background grid */}
            <div className="flex absolute inset-0">
              {Array.from({ length: 16 }, (_, i) => (
                <div
                  key={i}
                  className="border-r border-gray-600 opacity-30"
                  style={{ width: `${zoom}px` }}
                />
              ))}
            </div>
            ...
            {[
              ...
              <div
                key={idx}
                className="absolute top-2 bg-green-600 text-white text-xs px-2 py-1 rounded"
                style={{ left: `${chord.beat * zoom + 2}px` }}
              >
                {chord.symbol}
              </div>
            ))}
        ...
        <div className="mb-4">
          ...
          >
            ...
            {[
              ...
              <div
                key={idx}
                className="absolute top-2 bg-purple-600 text-white text-xs px-1 py-1 rounded"
                style={{ left: `${lyric.beat * zoom + 2}px` }}
                title={lyric.text}
              >
                ♪
              </div>
