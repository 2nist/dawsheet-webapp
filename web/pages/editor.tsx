      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-3xl font-[800] tracking-wide" style={{ fontFamily: "Special Elite, serif" }}>Song Editor</h1>
          </div>
    ...
    <div className="bg-[#efe3cc] border border-black/15 rounded-[6px] p-4 shadow-[0_1px_0_rgba(0,0,0,.25)]">
      ...
      <div className="mb-6">
        ...
        <div className="bg-white border border-black/10 rounded p-4 overflow-x-auto">
          <div className="flex mb-4" style={{ minWidth: `${totalBeats * 40}px` }}>
            {Array.from({ length: totalBeats }, (_, i) => (
              <div
                key={i}
                className={`flex flex-col items-center border-r border-gray-600 ${
                  i % section.beatsPerBar === 0 ? 'border-l-2 border-l-gray-400' : ''
                }`}
                style={{ width: '40px' }}
              >
          ...
          <div className="mb-4">
            ...
            <div className="flex relative h-8" style={{ minWidth: `${totalBeats * 40}px` }}>
              {Array.from({ length: totalBeats }, (_, i) => (
                <div
                  key={i}
                  className="border-r border-gray-700 border-opacity-30 h-full"
                  style={{ width: '40px' }}
                />
              ))}
              {section.chords.map((chord, index) => (
                <div
                  ...
                  style={{
                    left: `${chord.beat * 40}px`,
                    width: `${chord.duration * 40}px`
                  }}
                >
          ...
          <div>
            ...
            <div className="flex relative h-10" style={{ minWidth: `${totalBeats * 40}px` }}>
              {Array.from({ length: totalBeats }, (_, i) => (
                <div
                  key={i}
                  className="border-r border-gray-700 border-opacity-30 h-full"
        ...
        <div className="bg-white border border-black/10 rounded p-4">
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-3 gap-2">
              <div>
                <label className="block text-xs mb-1 font-typewriter font-bold text-black">Beat</label>
                <input
                  type="number"
                  value={newChord.beat}
              ...
              <div>
                <label className="block text-xs mb-1 font-typewriter font-bold text-black">Chord</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs mb-1 font-typewriter font-bold text-black">Duration</label>
                <input
                  type="number"
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-4 gap-2">
              ...
              <div className="col-span-3">
                <label className="block text-xs mb-1 font-typewriter font-bold text-black">Text</label>
                <input
                  type="text"
                  value={newLyric.text}
